...
if(!is_user_logged_in()) {
    ...
    // once it performs the redirect it can stop and rest and not use server resources.
    exit;
}
get_header();
while (have_posts()) {
    ...
    <div class="container container--narrow page-section">
        ...
        <ul class="min-list link-list" id="my-notes">
            ...
            // whenever we are using information from the database as value of html attribute
            // wrap it inside esc_attr
