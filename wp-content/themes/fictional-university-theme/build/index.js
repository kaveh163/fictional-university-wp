...
class Like {
  ...
  ourClickDispatcher(e) {
    ...
    // for toggling between the likes use 'attr' instead of 'data' since 'data
  ...
  async createNote() {
    ...
    try {
      ...
      if (response.data != "You have reached your note limit.") {
        ...
        setTimeout(function () {
          //the empty string simply removes the override and allows the original CSS setting to take effect again
          //height: '';
...
class Search {
  ...
  openOverlay() {
    ...
    //return false will prevent the default behaviour of <a> or link elements.
    return false;
  }
  closeOverlay() {
