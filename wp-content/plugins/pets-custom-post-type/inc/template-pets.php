...
<div class="container container--narrow page-section">
  ...
  <?php
  // benefits of wordpress custom post type table:
  // crud operations easily with the admin panel
  // gives rest apis endpoints
  // automatically ties up the posts to permission groups or permission roles
  // use of wordpress custom table:
  // need to be able to query based on piece of custom meta data
  // having a lot of those posts
