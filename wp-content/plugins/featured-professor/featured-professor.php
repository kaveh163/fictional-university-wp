...
class FeaturedProfessor {
 ...
 function addRelatedPosts($content) {
  // returns true if we are in a single screen with professor post type
  ...
  function onInit() {
    // Strings will be extracted to: plugins/featured-professor/languages/featured-professor.pot
    // dirname gives the directory where the current file exists
    ...
    // Tie the script to the translation system. The langauge files are located in languages folder
