...
// we do not need to use npm for installing react and react-dom package.
// wp-element library is just React.
// it has core functions of React and ReactDOM built in to it.



// there maybe more than one block instance of our block typen in a post
const divsToUpdate = document.querySelectorAll(".paying-attention-update-me");
divsToUpdate.forEach(function (div) {
  const data = JSON.parse(div.querySelector("pre").innerHTML);
  const root = react_dom_client__WEBPACK_IMPORTED_MODULE_2__.createRoot(div);
  root.render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Quiz, data));
